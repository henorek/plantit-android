...
import com.henorek.plantit.di.components.DaggerGameLevelsComponent;
import com.henorek.plantit.di.components.GameLevelsComponent;
...
public class SelectMapViewFragment extends
    MvpLceViewStateFragment<SwipeRefreshLayout, List<GameLevelApi>, ISelectMapView, SelectMapPresenter>
    implements ISelectMapView, SwipeRefreshLayout.OnRefreshListener {

  @Bind(R.id.fsmv_select_map_view) RecyclerView mapsView;
  ...
  protected void injectDependencies() {
    gameLevelsComponent = DaggerGameLevelsComponent.builder()
        .gameLevelsModule(new GameLevelsModule(getActivity()))
        .build();
  ...
  @NonNull @Override public LceViewState<List<GameLevelApi>, ISelectMapView> createViewState() {
    return new RetainingLceViewState<>();
  }

  @Override public List<GameLevelApi> getData() {
    return adapter.getGameLevelApis();
  }

  @Override public void setData(List<GameLevelApi> data) {
  ...
  @NonNull @Override public SelectMapPresenter createPresenter() {
