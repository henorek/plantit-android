...
@Module @Singleton public class TacticsModule {
  ...
  @Provides public TacticsService providesTacticsService() {
    Retrofit restAdapter =
        new Retrofit.Builder().baseUrl(TacticsService.TACTICS_REPOSITORY_ENDPOINT)
