package net.henorek.plantit.data.disk;

import net.henorek.plantit.data.IDiskDataStore;
import net.henorek.plantit.data.disk.dao.TacticDao;
...
public class DiskDataStore implements IDiskDataStore {
  ...
  @Inject
  public DiskDataStore(TacticDao dao) {
    this.dao = dao;
  }
